...
export default function Navbar() {
    ...
    return (
        <>
            ...
            <header id="xb-header-area" className="site-header header-marketing is-sticky p-3">
                <div className="xb-header__top">
                    <div className="container m-auto ul_li_between  d-flex justify-content-between">
                        <div className="xb-social ul_li  p-3">
                            <span>Follow us :</span>
                            <ul className="ul_li">
                                <li><a href="https://www.instagram.com/dhanwistechinfosolutions/"><i className="fab fa-instagram" /></a></li>
                                <li><a href="https://www.facebook.com/dhanwisinfo"><i className="fab fa-facebook-f" /></a></li>
                                <li><a href="https://in.linkedin.com/in/dhanwis-techinfo-solutions-9505622a7"><i className="fab fa-linkedin-in" /></a></li>
                                <li><a href="#!"><i className="fab fa-pinterest-p" /></a></li>
                            </ul>
                        </div>
                        <div className=''>
                            <button className='btn btn-warning btn-sm'> Let's Talk
                        ...
                        <div className="ul_li_between">
                                    ...
                                    <ul>
                                        ...
                                        <li className="menu-item-has-children">
                                            ...
                                            <ul className="submenu">
                                                <li><NavLink to={"/appDevelopment"}><span>Mobile App Development</span></NavLink></li>
                                                <li>  <NavLink to={"/softwaredevelopment"}><span>Software Development</span></NavLink> </li>
                                                <li><NavLink to={"/digital-marketing"}><span>Digital Marketing</span></NavLink> </li>
                                                <li> <NavLink to={'web design/developement'}><span>Web Design &amp; Development</span></NavLink> </li>
                            ...
                            <div className="xb-header__right ul_li">
                                <ul className="xb-header__action ul_li">
                                    <li><a className="header-search-btn" onClick={() => setShowSearch(!showSearch)}><img src="public/img/icon/ins_search.svg" alt="" /></a></li>
                                </ul>
            ...
            <div className={`offcanvas-sidebar ${show ? 'active' : ''}`} >
                ...
                <div className="sidebar-contact-info mb-65">
                    ...
                    <ul className="sidebar-info-list list-unstyled">
                        <li><span><img src="/img/icon/star-2.svg" alt="" /></span>Kannur Kerala, India, 670702</li>
                        <li><a href="#!"><span><img src="/img/icon/star-2.svg" alt="" /></span>+91 996 148 72 19</a></li>
                        <li><a href="#!"><span><img src="/img/icon/star-2.svg" alt="" /></span>+91 808 648 72 19</a></li>
                        <li><a href="#!"><span><img src="/img/icon/star-2.svg" alt="" /></span>dhanwistechinfosolutions@gmail.com</a></li>
